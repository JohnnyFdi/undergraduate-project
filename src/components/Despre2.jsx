...
const Despre2 = () => {
  return (
    <div className="despre2-wrapper">
        <div className="despre2-container1">
            <div className="container1-content">
                <h2>MISIUNE</h2><br />
                <p>Împreună construim și dezvoltăm spații de locuit pentru o viață valoroasă.</p>
            </div>
            <div className="container1-content">
                <h2>VIZIUNE</h2><br />
                <p>Susținem noi valori în România.</p>
            </div>
        </div>
        <div className="despre2-container2">
            <div className="container2-content">
                <h2>ASPIRATIILE NOASTRE</h2> <br />
                <p>Fiecare membru al echipei este unul dintre principalii experți în domeniul său.</p>
                <p>Stabilim cele mai înalte standarde pentru produsele și serviciile noastre.</p>
                <p>Tot ceea ce planificăm și facem în fiecare zi trebuie să ne umple pe fiecare dintre noi de mândrie.</p>
            </div>
        </div>
        <div className="despre2-container3">
            ...
            <div className="container3-content" id="despre3-dreapta">
                <h3>RESPECT</h3><br />
        ...
        <div className="despre2-container4">
            <div className="container4-content">
                <h1>Îndrăznește să crezi în visul tău!</h1> <br />
                <p>Noi am făcut acest lucru și, alături de mii de români, am reușit să conturăm un viitor de care să fim mândri.</p>
                <p>Dedicarea, implicarea și respectul au fost elementele care au stat la baza a tot ceea ce am reușit să construim, arătând că se poate și altfel.</p>
            </div>
        </div>
